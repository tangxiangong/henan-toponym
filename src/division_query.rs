...
pub struct DivisionQueryRequest {
...
impl Default for DivisionQueryRequest {
    fn default() -> Self {
        Self {
            year: None,
            code: None,
...
mod tests {
    ...
    fn test_division_query_request() {
        let request = DivisionQueryRequest::new(2024, "110101".to_string(), QueryLevel::Child);
